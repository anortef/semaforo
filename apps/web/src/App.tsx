...
import { AppAuditLogPage } from "./pages/AppAuditLogPage.js";
  ...
  return (
    <Routes>
      <Route element={<Layout />}>
        ...
        <Route path="/apps/:appId/secrets" element={<SecretsPage />} />
        ...
        <Route path="/apps/:appId/audit-log" element={<AppAuditLogPage />} />
